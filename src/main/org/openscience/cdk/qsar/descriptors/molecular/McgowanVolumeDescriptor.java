 ...
 * reversed phase liquid chromatography. Chromatographia. 1987;23:243-6.
 * <p/>
...
public class McgowanVolumeDescriptor implements IMolecularDescriptor {
    ...
    public static final String[] names = {"McGowan_Volume"};
    ...
    /**
     * Return the parameter names for this descriptor.
     *
     * @return null since the descriptor takes no parameters
     */
    ...
    /**
     * Set parameters for the descriptor.
     *
    ...
    /**
     * Get parameters for this descriptor.
     *
     * @return null since there are no parameters
     */
    ...
    /**
     * Evaluate the McGowan volume descriptor for a molecule.
     *
     * @param container the molecule to proccess
     * @return a {@link DescriptorValue} object representing the calculated value
     */
